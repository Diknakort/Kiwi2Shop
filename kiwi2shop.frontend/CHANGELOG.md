...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest kiwi2shop.frontend -- --template=react-ts`.
- Crear archivo de proyecto (`kiwi2shop.frontend.esproj`).
